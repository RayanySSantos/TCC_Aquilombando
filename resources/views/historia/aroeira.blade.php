...
<section class="historia-hero">
    <div class="historia-hero-container historia-hero-container--top">
        <div class="historia-hero-texto">
           ...
           <p>
                O Quilombo Aroeira está situado na zona rural do município de Palmas de Monte Alto, Bahia, e tem suas origens
                diretamente relacionadas à trajetória de Vitor Brito, um homem livre que foi escravizado e posteriormente obteve
                sua carta de alforria. A partir de sua história, construiu-se um legado de resistência que se expandiu por diversos
                quilombos dos territórios do Sertão Produtivo e do Velho Chico, formando a base da memória coletiva, da luta pelo
                território e da identidade cultural da Comunidade Quilombola de Aroeira.
            </p>
        ...
        <div class="historia-midia">
            ...
            <div class="historia-galeria-fontes">
                <p class="historia-galeria-fonte">Fonte: Quilombo Aroeira; Projetos “Mapeamento Gastronômico”; “Culinária Ancestral”; e “Vozes do Sertão” (2025).</p>
            </div>
        </div>
    </div>
</section>
