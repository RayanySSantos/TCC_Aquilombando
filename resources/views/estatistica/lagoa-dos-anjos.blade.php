...
<div class="estatistica-container">
    <section class="estatistica-card estatistica-card--duo">
        <div class="estatistica-card-grafico">
            <img src="{{ asset('images/Vargem Alta/estatistica/') }}" alt="Gráfico de idade em Lagoa dos Anjos">
        </div>
    ...
    <section class="estatistica-card estatistica-card--duo">
        ...
        <div class="estatistica-card-grafico">
            <img src="{{ asset('images/Vargem Alta/estatistica/') }}" alt="Atividades econômicas em Lagoa dos Anjos">
        </div>
    </section>
    ...
    <section class="estatistica-card estatistica-card--duo">
        ...
        <div class="estatistica-card-grafico">
            <img src="{{ asset('images/Vargem Alta/estatistica/') }}" alt="Tempo de moradia em Lagoa dos Anjos">
        </div>
    </section>
</div>
@endsection
