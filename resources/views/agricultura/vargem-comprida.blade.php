...
@section('content')
<section class="secao-capa" style="background-image: linear-gradient(rgba(58, 15, 15, 0.45), rgba(58, 15, 15, 0.35)), url('{{ asset('images/Vargem Comprida/Agricultura/h1.jpeg') }}');">
...
<section class="agricultura-hero">
    <div class="agricultura-hero-container">
        <div class="agricultura-hero-texto">
            <h2 class="secao-titulo">Vargem Comprida: Cultivo e Permanência</h2>
        ...
        <div class="agricultura-hero-galeria">
            ...
            <div class="agricultura-foto"><img src="{{ asset('images/Vargem Comprida/Agricultura/h1.jpeg') }}" alt="Vargem Comprida 5"></div>
            <div class="agricultura-foto"><img src="{{ asset('images/Vargem Comprida/Agricultura/h2.jpeg') }}" alt="Vargem Comprida 6"></div>
        </div>
    </div>
</section>
@endsection
