...
<section class="agricultura-hero">
    <div class="agricultura-hero-container">
        <div class="agricultura-hero-texto">
            ...
            <p>A agricultura familiar ocupa um papel central na subsistência e no modo de vida da Comunidade Quilombola de Vargem Comprida. Em pequenos roçados próximos às residências, os moradores cultivam feijão, milho, mandioca, batata-doce, maxixe, abóbora, hortaliças, frutas e diversas raízes, garantindo alimentos frescos, saudáveis e produzidos de forma tradicional. Esse cultivo cotidiano expressa a relação histórica da comunidade com a terra, marcada pelo cuidado, pelo respeito aos ciclos naturais e pela valorização dos saberes herdados dos antepassados.</p>

            <p>O trabalho na roça é realizado de forma coletiva, envolvendo diferentes gerações da comunidade. Pais, filhos e netos compartilham experiências e conhecimentos relacionados ao plantio, ao manejo do solo e às práticas agrícolas sustentáveis, promovendo momentos de aprendizado e fortalecendo os laços familiares e comunitários. Essa convivência diária assegura a continuidade dos modos tradicionais de cultivo e reforça o sentimento de pertencimento ao território.</p>

            <p>Além de garantir o abastecimento alimentar das famílias, a agricultura familiar possibilita a comercialização do excedente em feiras e mercados locais, contribuindo para a geração de renda e para a autonomia econômica da comunidade. Dessa maneira, a agricultura em Vargem Comprida vai além da função de sustento, afirmando-se como expressão de identidade, memória coletiva e resistência quilombola, elementos fundamentais para a manutenção do modo de vida tradicional.</p>
        </div>
        ...
        <div class="agricultura-midia">
            ...
            <p class="agricultura-galeria-fonte">Fonte: Quilombo Vargem Comprida; Projeto Mapeamento Gastronômico (2025).</p>
        </div>
    </div>
</section>
@endsection
