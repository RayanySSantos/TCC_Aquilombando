...
@section('content')
<section class="secao-capa" style="background-image: linear-gradient(rgba(58, 15, 15, 0.85), rgba(58, 15, 15, 0.35)), url('{{ asset('images/Aroeira/artesanato/artesanato06.png') }}');">
    ...
    <div class="artesanato-hero-container artesanato-hero-container--top">
        ...
        <div class="artesanato-midia">
            <div class="artesanato-hero-galeria artesanato-hero-galeria--vertical">
                ...
                <p class="artesanato-galeria-fonte">Fonte: Quilombo Aroeira; Projetos “Mapeamento Gastronômico”; “Culinária Ancestral”; e “Vozes do Sertão” (2025).</p>
        </div>
    </div>
</section>
@endsection
